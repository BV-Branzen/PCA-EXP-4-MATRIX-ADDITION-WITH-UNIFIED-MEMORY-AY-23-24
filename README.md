...
```
```
!nvcc -arch=sm_75 -o unifmem1 unifmem1.cu
```
```
!nvprof ./unifmem1
```
...
```
```
!nvcc -arch=sm_75 -o unifmem2 unifmem2.cu
```
```
!nvprof ./unifmem2
```
...
<img width="1409" height="785" alt="image" src="https://github.com/user-attachments/assets/5a70180d-1f4e-4427-a697-c3cc9d68d9e4" />


<img width="1329" height="804" alt="image" src="https://github.com/user-attachments/assets/8e66a32d-5a4f-404f-95d7-e2e24ede060b" />
